...
int    MQTT_createDeviceAlarm (HomeHeartBeatSystem_t *aSystem, HomeHeartBeatDevice_t *deviceRecPtr)
{
    ...
    char    *alarmFormatStringJSON = "{\"topic\" : \"%s\", \"datetime\" : \"%s\" , \"deviceType\" : %2d , \"type\" : \"%s\" , \"name\" : \"%s\" , \"state\" : \"%s\" , \"duration\" : %d, \"MACAddress\" : \"%s\" }";
...
int    MQTT_createDeviceEvent (HomeHeartBeatSystem_t *aSystem, HomeHeartBeatDevice_t *deviceRecPtr)
{
    ...
    char    *statusFormatStringJSON = "{\"topic\" : \"%s\",  \"datetime\" : \"%s\" , \"deviceType\" : %2d , \"type\" : \"%s\" , \"name\" : \"%s\" , \"state\" : \"%s\" , \"duration\" : %d , \"setAlarmAction\" : \"%s\" , \"unsetAlarmAction\" : \"%s\" , \"setCallAction\" : \"%s\" , \"unsetCallAction\" : \"%s\" , \"online\" : \"%s\" , \"battery\" : \"%s\" , \"triggered\" : \"%s\" , \"MACAddress\" : \"%s\" }";
    char    *sensorType = NULL;
    char    *sensorName = NULL;
